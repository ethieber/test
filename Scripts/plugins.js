...
*  2) ESKORT Accordion
*  3) jQuery Form Plugin version: 3.20 (20-NOV-2012) - http://malsup.com/jquery/form/
*  4) jQuery Validation Plugin 1.11.1 - http://bassistance.de/jquery-plugins/jquery-plugin-validation/
*/

/**
 * 1) hoverIntent r7 // 2013.03.11 // jQuery 1.9.1+
...
(function ($) {
  $.fn.eAccordion = function (options) {
    ...
    function addExpand($this) {
      var $expandControl = $('<div class="expandCollapseAll"><a href="index.htm#" class="expand">Expand All</a> | <a href="index.htm#" class="collapse">Collapse All</a></div>').prependTo('.accordion')
    }
